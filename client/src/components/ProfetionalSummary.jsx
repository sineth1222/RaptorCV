...
const ProfetionalSummary = ({data, onChange, setResumeData}) => {
  ...
  return (
    <div className='space-y-4'>
        <div className='flex flex-col sm:flex-row sm:items-center sm:justify-between gap-8 sm:gap-0'>
            ...
            <button disabled={isGenerating} onClick={generateSummary} className='flex items-center w-fit ml-auto sm:ml-0  gap-2 px-3 py-2 text-sm bg-purple-100 text-purple-700 rounded hover:bg-purple-200 transition-colors disabled:opacity-50'>
...
export default ProfetionalSummary
