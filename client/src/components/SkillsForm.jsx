  ...
  return (
    <div className='space-y-4'>
        <div>
            ...
            <p className='text-sm text-gray-500'>Add your tecnical and soft skills</p>
        </div>

        <div className='flex gap-2'>
            <input type="text" placeholder='Enter a skill (e.g., JavaScript, project management)' className='flex-1 px-3 py-2 text-sm' onChange={(e) => setnewSkill(e.target.value)} value={newSkill} onKeyDown={hadleKeypress}/>
        ...
        <div className='bg-blue-50 p-3 rounded-lg'>
            <p className='text-sm text-blue-800'><strong>Tip:</strong> Add 8-12 relavant skills. Include both technical skills (programming languages, tools) and soft skills (leadership, communication).</p>
        </div>
